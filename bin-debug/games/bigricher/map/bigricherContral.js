...
(function (map) {
   ...
   */
        bigricherContral.prototype.createGameScene = function () {
            ...
            bigRicher.width = this.width;
            bigRicher.height = this.width * 938 / 1454;
            ...
            //  XhGame.Tools.displayCenter(bigRicher);
            ...
            XhGame.EventBus.addEventListener("event_play", this.callback, this);
            XhGame.EventBus.addEventListener("event_play_enable", this.callback, this);
            ...
            playShaizi.bottom = 110;
            playShaizi.horizontalCenter = 0;
            this.playShaizi.shaizi.addEventListener(egret.TouchEvent.TOUCH_TAP, this.click, this);
            this.playShaizi.shaizi.touchChildren = false;
        };
        bigricherContral.prototype.callback = function (event) {
            ...
            else if ("event_play" == event.type) {
            }
            else if ("event_play_enable" == event.type) {
                this.playShaizi.shaizi.touchEnabled = true;
            }
        };
        bigricherContral.prototype.click = function (evt) {
            ...
            XhGame.Tools.ButtonBound(target, function () {
                ...
                _this.playShaizi.shaizi.touchEnabled = false;
        ...
        bigricherContral.prototype.mouseMove = function (evt) {
            ...
            if (this.touchCon == 2) {
                ...
                var det = newdistance / this.distance;
                var scale = this._bird.scaleX * det;
